...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/gong/network/src/control)
  set(control_DEVEL_PREFIX /home/gong/network/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/gong/network/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'gong <gong@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gong/network/src/control/${idir}'.  Ask the maintainer 'gong <gong@todo.todo>' to fix it.")
    endif()

...
if("FALSE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/gong/network/src/rviz)
  set(rviz_DEVEL_PREFIX /home/gong/network/devel)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/gong/network/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'gong <gong@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gong/network/install/${idir}'.  Ask the maintainer 'gong <gong@todo.todo>' to fix it.")
    endif()
